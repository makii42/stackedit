    ...
    function authenticate(task) {
        task.onRun(function() {
            ...
            function oauthRedirect() {
                utils.redirectConfirm('You are being redirected to <strong>box.com</strong> authorization page.', function() {
            ...
            function localAuthenticate() {
                ...
                client.authenticate({
                    ...
                    // Error
                    task.error(new Error("Access to box.com account is not authorized."));
                });
            }
            task.chain(localAuthenticate);
        });
